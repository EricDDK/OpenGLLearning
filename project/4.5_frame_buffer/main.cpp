...
int main(int argc, char * argv[])
{
	...
	Shader shader("../project/4.5_frame_buffer/Shader.vs", "../project/4.5_frame_buffer/Shader.fs");
	Shader screenShader("../project/4.5_frame_buffer/Shader_2.vs", "../project/4.5_frame_buffer/Shader_2.fs");
